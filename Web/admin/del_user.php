<?php 
 ...
 <?php 
  ...
  <?php 
    ...
    $sql2 = "delete from user where user.userid='$userid'";
    $sql3 = "delete from register where register.userid='$userid'";
    $del = mysql_query($sql,$conn);
    $del2 = mysql_query($sql2,$conn);
    $del3 = mysql_query($sql3,$conn);
    if ($del and $del2 and $del3 and empty($content)) {
     echo "<script> window.location.href='view_user.php';
           </script>;";
