 ...
 if (isset($_GET['content'])|| !empty($_GET['content']))  {  
  ...
  <?php while ($res = mysql_fetch_array($sel)) {?>  
    <tr>
        ...
        <td><a href="del_suggestion.php?&&suggestionid=<?php echo $res['suggestionid'];?>&&content=<?php echo $content; ?>" onclick="return confirmAct();"><input type="submit" value="删除"></a></td>
    </tr>
   <?php }?>
   </table>
   <?php 
